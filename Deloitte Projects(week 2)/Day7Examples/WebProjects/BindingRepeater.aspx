<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BindingRepeater.aspx.cs" Inherits="WebProjects.BindingRepeater" %>
            ...
            <HeaderTemplate>
                <table border="1">
                    ...
                    <tr style="background-color:azure">
                        <td style="background-color:cadetblue;font-size:x-large">
                            Register Shopping Data
                        </td>
                    </tr>
                </table>
            </HeaderTemplate>
